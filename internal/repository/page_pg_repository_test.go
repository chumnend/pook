...
func TestPageRepository_FindAllByBookID(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		repo := NewPagePostgresRepository(gdb)
...
func TestPageRepository_FindByID(t *testing.T) {
	...
	t.Run("fail", func(t *testing.T) {
		...
		// check
		mock.ExpectationsWereMet()
		assert.Equal(t, entity.Page{}.ID, page.ID)
		assert.Equal(t, entity.Page{}.Content, page.Content)
		assert.Equal(t, entity.Page{}.BookID, page.BookID)
		assert.Error(t, err)
	})
}
